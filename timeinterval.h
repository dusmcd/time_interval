...
class TimeInterval
{
    ...
    public:
        // constructors
        TimeInterval(const TimeOfDay &start_time = TimeOfDay(),
         const TimeOfDay &end_time = TimeOfDay());
        TimeInterval(const TimeOfDay &start_time, int length, string units);
        ...
        // mutator functions
        void SetStartTime(const TimeOfDay &start_time);
        void SetEndTime(const TimeOfDay &end_time);
        void SetEndTime(int length, string units);

        void Print(bool military = false, bool show_seconds = false) const;
